<template>
<div>
  <el-dialog title="修改普通用户" width="40%" :destroy-on-close="true" :visible.sync="updateUserVisible" :before-close="handleClose">
...
<script>
  import {getUserById,editUser} from '../../../api/manage.js'
  export default {
    data() {
      return{
        formLabelWidth: '80px',
