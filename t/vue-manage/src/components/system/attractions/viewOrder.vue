      ...
      <el-row :gutter="10">
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            ...
            <el-form-item prop="attractionsId" style="margin-bottom:0">
                <el-input v-model="form.attractionsId" size="mini" placeholder="请输入景点id" autocomplete="off"></el-input>
            </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <span class="search-title">
...
<script>
  import {editSysAttractionOrder,getSysAttractionOrderById} from '../../../api/manage.js'
  export default {
    data() {
      return{
        formLabelWidth: '80px',
